                        ...
                        <div class="card mb-3 rounded-3 shadow-sm">
                            <div class="card-header py-3">
                                ...
                                <p class="d-flex gap-1">
                                    <a class="btn btn-info col-4" data-bs-toggle="collapse" href="#collapseExample1"
                                       role="button" aria-expanded="false" aria-controls="collapseExample">
                                        Как купить?
                                    </a>
                                    <button class="btn btn-info col-4" type="button" data-bs-toggle="collapse"
                                ...
                                <div class="collapse" id="collapseExample1">
                                    <div class="card card-body">
                                        Для приобретения товара наберите его в корзину и нажмите кнопку "Купить"
                                    </div>
                                </div>
                                <div class="collapse" id="collapseExample2">
                                    <div class="card card-body">
                                        Для доставки товара с вами свяжется оператор
                                    </div>
                                </div>
